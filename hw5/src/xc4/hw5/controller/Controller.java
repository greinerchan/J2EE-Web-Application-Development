...
import xc4.hw5.controller.CommentAction;
import xc4.hw5.controller.PostAction;
import xc4.hw5.controller.CommentDeleteAction;
import xc4.hw5.controller.PostDeleteAction;
import xc4.hw5.controller.HomeAction;
import xc4.hw5.controller.VisitorAction;
import xc4.hw5.controller.Action;
import xc4.hw5.controller.LoginAction;
import xc4.hw5.controller.LogoutAction;
import xc4.hw5.controller.RegisterAction;
...
public class Controller extends HttpServlet {
    ...
    public void init() throws ServletException {
        ...
        Action.add(new PostDeleteAction(model));
        Action.add(new CommentAction(model));
        Action.add(new CommentDeleteAction(model));
        Action.add(new UserAction(model));
        Action.add(new HomeCommentAction(model));
        Action.add(new VisitorCommentDeleteAction(model));
    }
